...
try:
    ...
    cur.execute("""
        SELECT name, tenant_id, array_agg(id) as ids, array_agg(updated_at) as updated_ats
        FROM plans
    ...
    for duplicate in duplicates:
        ...
        cur.execute(
            ...
            (str(golden_id), [str(id) for id in duplicate_ids])
        )
        ...
        cur.execute(
            ...
            ([str(id) for id in duplicate_ids],)
        )
